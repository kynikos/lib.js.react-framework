...
(function () {
  ...
  // jss
  // styled-jss
  module.exports = function (rootReducerMap, _ref) {
    var responsiveBreakpoints = _ref.responsiveBreakpoints;

    var App, history, store, storeEnhancers;
    ...
    store = createStore(connectRouter(history)(combineReducers(rootReducerMap)), composeWithDevTools.apply(undefined, _toConsumableArray(storeEnhancers)));
